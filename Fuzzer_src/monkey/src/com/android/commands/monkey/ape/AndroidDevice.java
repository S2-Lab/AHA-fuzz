...
public class AndroidDevice {
    ...
    public static void initializeAndroidDevice(IActivityManager mAm, IWindowManager mWm, IPackageManager mPm) {
        ...
        // inputMethodservice = (InputMethodservice) ContextUtils.getSystemContext
    ...
    public static int getRotation() {
        try {
            return iWindowManager.getDefaultDisplayRotation();
    ...
    public static boolean isVirtualKeyboardOpened() {
        try {
            ...
            Logger.println("adb executing \"dumpsys input_method | grep mInputShown\" wrong!");
        }
    ...
    public static boolean checkAndSetInputMethod() {
        try {
            ...
            Utils.switchToIme(IME_ADB_KEYBOARD);
            return true;
        } catch (SecurityException e) {
            e.printStackTrace();
        }
